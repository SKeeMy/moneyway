...
class IncomeController extends Controller
{
    ...
    {
        $balance = Income::where([['remember_token', $remember_token], 
    ...
    {
        $income = Income::where([['remember_token', $remember_token], 
    ...
    public function delete(Request $request){
        $delete = Income::firstWhere([['remember_token', $request -> {"remember_token"} ],
        ['id',$request -> {"id"}]]);
        if(!$delete){
    ...
    public function history(Request $request){
        ...
        $income_history = Income::where('remember_token', $token)
        ->orderBy('created_at', 'asc')
